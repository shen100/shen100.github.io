...
## 敏感信息加密
在 **my-data** 项目，打开 `shen100/github/io/webToolPassword.js` 文件，找到 `webToolPassword`, 然后打开浏览器控制台并执行  
```
...
对整个 markdown 的文本内容加密的话，访问 `https://shen100.github.io/webtool/encryption`
<img src="/image/docs/4/8.png" />  
