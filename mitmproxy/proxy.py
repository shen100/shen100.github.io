...
def response(flow: http.HTTPFlow) -> None:
    ...
    if pattern.search(url):
        ...
        if flow.response.content and flow.response.headers.get("Content-Type", "").startswith("text/css"):
            ...
            append_css = "\n.size14, .size14 * { font-size: 16px!important; } #app .dom-prettier { font-size: 16px!important; } .detail-main__smart-info { font-size: 16px!important; } .detail-title { font-size: 16px!important; }"
